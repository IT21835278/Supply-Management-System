        ...
        <div>
            ...
            <div className="flex items-center justify-between mb-4">
                ...
                <button className="px-4 py-2 ml-4 bg-blue-500 text-white rounded-lg hover:bg-blue-600">
                    <Link to={'/add-suppliers'}>Create</Link>
                </button>
            </div>
                    ...
                    {filteredUsers.length > 0 ? (
                        ...
                        <tr key={record._id} class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                            ...
                            <button>
                                ...
                                <button onClick={() => deleteSupplierbtn(record._id)} class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Delete</button>
                            </td>
                        </tr>
                        ))
                        ) : (
